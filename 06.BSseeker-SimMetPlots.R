...
PlotTag1 <- c(args[1])
PlotTag2 <- c(args[2])
workFolder <- c(paste("/home/user/", PlotTag1, "-", PlotTag2, "/003-bsseeker/", sep=''))

D <- read.table(paste(workFolder,PlotTag2,"-BSseekerTable-01-CpG-",PlotTag1,".txt",sep=''),sep='\t',header=T)
summary(D)
